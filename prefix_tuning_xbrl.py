...
tokenizer_name_or_path = "flan-t5-xl"
...
for epoch in range(num_epochs):
    ...
    model.save_pretrained('./prefix_tuning_trained_model')
    ...
    for step, batch in enumerate(tqdm(eval_dataloader)):
        ...
        outputs = model.generate(input_ids=batch["input_ids"], max_new_tokens=100)
...
f1 = open('./prefix_tuning_prediction.txt', 'w')
